...
public class RedirectB extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.write("<!DOCTYPE html>\r\n");
	      ...
	      out.write("            <li><a href=\"day0712/parameter_values\">이름이 중복될때</a></li>\r\n");
	      ...
	      out.println("<span style='color:#ff0000'>비정상적인 요청이 발생하였습니다</span>");
	      out.println("<a href='redirect_a?name=donghee.kim&age=29'>요청</a><br>");
