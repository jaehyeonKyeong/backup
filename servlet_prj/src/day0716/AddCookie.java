...
public class AddCookie extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.write("<!DOCTYPE html>\r\n");
	      ...
	      Cookie nameCookie=new Cookie("name","donghee.kim");
	      Cookie ageCookie=new Cookie("age", "29");
//	      Cookie addrCookie=new Cookie("addr","29"); 한글 심기 불가능
	      Cookie addrCookie=new Cookie("addr",HangulConv.to8859("서울시 중동구"));// 한글 심기 불가능
	      
	      
	      //생존시간 설정
	      nameCookie.setMaxAge(60*2);
	      ageCookie.setMaxAge(60*2);
	      addrCookie.setMaxAge(60*2);
	      //쿠키 심기
	      response.addCookie(nameCookie);
	      response.addCookie(ageCookie);
	      response.addCookie(addrCookie);
	      
	      out.println("<strong>쿠키가 정상적으로 생성되었습니다.</strong><br>");
