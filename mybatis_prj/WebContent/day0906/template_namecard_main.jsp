...
<body>
			...
			<ul class="carousel" id="carousellatest">
				...
				<li>
					<div class="section block">	
						<img src="http://localhost:8080/mvc_login/common/img/placeholder_large1.jpg">
						<div class="content">
							<h5>Type Work</h5>
				...
				<li>
					<div class="section block">	
						<img src="http://localhost:8080/mvc_login/common/img/placeholder_large2.jpg">
						<div class="content">
							<h5>Type Work</h5>
							<h6>illustration/branding</h6>
						</div>
				...
				<li>
					<div class="section block">	
						<img src="http://localhost:8080/mvc_login/common/img/placeholder_large3.jpg">
						<div class="content">
							<h5>Type Work</h5>
							<h6>illustration/branding</h6>
						</div>
				...
				<li>
					<div class="section block">	
						<img src="http://localhost:8080/mvc_login/common/img/placeholder_large4.jpg">
						<div class="content">
							<h5>Type Work</h5>
							<h6>illustration/branding</h6>
						</div>
				...
				<li>
					<div class="section block">	
						<img src="http://localhost:8080/mvc_login/common/img/placeholder_large5.jpg">
						<div class="content">
							<h5>Type Work</h5>
							<h6>illustration/branding</h6>
						</div>
			...
			<ul class="carousel" id="carouselblog">
				...
				<li>
					<div class="section block blog active">
						<img src="http://localhost:8080/mvc_login/common/img/placeholder_large_blog2.jpg">
						<div class="content">
							<h5>Article</h5>
				...
				<li>
					<div class="section block blog active">
						<img src="http://localhost:8080/mvc_login/common/img/placeholder_large_blog1.jpg">
						<div class="content">
							<h5>Article</h5>
							<h6>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.</h6>
							<a href="#" class="readmore color">read more >></a>
				...
				<li>
					<div class="section block blog active">
						<img src="http://localhost:8080/mvc_login/common/img/placeholder_large_blog3.jpg">
						<div class="content">
							<h5>Article</h5>
							<h6>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.</h6>
							<a href="#" class="readmore color">read more >></a>
				...
				<li>
					<div class="section block blog active">
						<img src="http://localhost:8080/mvc_login/common/img/placeholder_large_blog4.jpg">
						<div class="content">
							<h5>Article</h5>
							<h6>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.</h6>
							<a href="#" class="readmore color">read more >></a>
	...
	<div class="content">
		...
		<div class="person">
			<div class="image quotefade">
				<img src="http://localhost:8080/mvc_login/common/img/person2.jpg">
				<div class="quotehover">
					<h5>“You have to do something you’ve never done 
					to have something you’ve never had.”</h5>
					<h6>Elizabeth Franklin</h6>
		...
		<div class="person">
			<div class="image quotefade">
				<img src="http://localhost:8080/mvc_login/common/img/person3.jpg">
				<div class="quotehover">
					<h5>“You have to do something you’ve never done 
					to have something you’ve never had.”</h5>
					<h6>Elizabeth Franklin</h6>
	...
	<ul class="portfolio">
		<li class="item design">
			<div class="portfolioitem">
				<img src="http://localhost:8080/mvc_login/common/img/portfolio1.jpg">
		...
		<li class="item design">
			<div class="portfolioitem">
				<img src="http://localhost:8080/mvc_login/common/img/portfolio2.jpg">
				<div class="portfoliohover">
					<div class="info">
						<h1>+</h1>
						<h5>Portfolio Item</h5>
		...
		<li class="item design">
			<div class="portfolioitem">
				<img src="http://localhost:8080/mvc_login/common/img/portfolio3.jpg">
				<div class="portfoliohover">
					<div class="info">
						<h1>+</h1>
						<h5>Portfolio Item</h5>
		...
		<li class="item branding">
			<div class="portfolioitem">
				<img src="http://localhost:8080/mvc_login/common/img/portfolio4.jpg">
				<div class="portfoliohover">
					<div class="info">
						<h1>+</h1>
						<h5>Portfolio Item</h5>
		...
		<li class="item branding">
			<div class="portfolioitem">
				<img src="http://localhost:8080/mvc_login/common/img/portfolio5.jpg">
				<div class="portfoliohover">
					<div class="info">
						<h1>+</h1>
						<h5>Portfolio Item</h5>
		...
		<li class="item illustration">
			<div class="portfolioitem">
				<img src="http://localhost:8080/mvc_login/common/img/portfolio6.jpg">
				<div class="portfoliohover">
					<div class="info">
						<h1>+</h1>
						<h5>Portfolio Item</h5>
		...
		<li class="item illustration">
			<div class="portfolioitem">
				<img src="http://localhost:8080/mvc_login/common/img/portfolio7.jpg">
				<div class="portfoliohover">
					<div class="info">
						<h1>+</h1>
						<h5>Portfolio Item</h5>
		...
		<li class="item illustration">
			<div class="portfolioitem">
				<img src="http://localhost:8080/mvc_login/common/img/portfolio8.jpg">
				<div class="portfoliohover">
					<div class="info">
						<h1>+</h1>
						<h5>Portfolio Item</h5>
	...
	<div class="content">
		...
		<div class="content sidebar" id="snippets">
			...
			<article class="post">				
				<div class="hover">	
					<div class="postimage">
						<img src="http://localhost:8080/mvc_login/common/img/post1.jpg">
			...
			<article class="post">
				<div class="hover">	
					<div class="postimage">
						<img src="http://localhost:8080/mvc_login/common/img/post2.jpg">
						<div class="posthover"><a class="openpost" href="javascript:void(0);" data-id="2">read more</a></div>
					</div>
					<div class="postinfo">
						<h6 class="mid-gray"><b class="dark-gray">Posted:</b> 17/9/13</h6>
			...
			<article class="post">				
				<div class="hover">	
					<div class="postimage">
						<img src="http://localhost:8080/mvc_login/common/img/post3.jpg">
						<div class="posthover"><a class="openpost" href="javascript:void(0);" data-id="2">read more</a></div>
					</div>
					<div class="postinfo">
						<h6 class="mid-gray"><b class="dark-gray">Posted:</b> 17/9/13</h6>
	...
	<div class="content">
		...
		<div class="logos">
			<img data-text="Lorem ipsum something" src="http://localhost:8080/mvc_login/common/img/logo.png">
			<img data-text="Lorem ipsum something" src="http://localhost:8080/mvc_login/common/img/logo.png">
			<img data-text="Lorem ipsum something" src="http://localhost:8080/mvc_login/common/img/logo.png">
			<img data-text="Lorem ipsum something" src="http://localhost:8080/mvc_login/common/img/logo.png">
			<img data-text="Lorem ipsum something" src="http://localhost:8080/mvc_login/common/img/logo.png">
