...
<body>
	...
	<a href="download.jsp?file_name=dept_att.xml">다운로드</a>
	<%
	}else{
	%>
	...
	public boolean createDeptXml() throws SQLException,IOException{
		...
		try{
			...
			while(rs.next()){
				...
				//속성 생성
				deptAtt=new Attribute("deptno",String.valueOf(rs.getInt("deptno")));
				//생성된 속성을 노드에 배치
				deptNode.setAttribute(deptAtt);
			...
			File file=new File("C:/dev/workspace/jsp_prj/WebContent/xml0820/dept_att.xml");
