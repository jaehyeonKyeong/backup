...
<body>
	...
	<div class="content">
		<div>
			<img src="http://localhost:8080/mvc_login/upload/${comImg }" style="width:200px"/>
			<ul>
			<li><strong> ${company }</strong> </li>
			<li><strong>(${position }) ${manager }</strong> </li>
			</ul>		
			의 명함이 성공적으로 추가 되었습니다.<br>
			[<a href="nc_list.do?cmd=NC_M001">명함목록</a> | <a href="nc_add.do?cmd=NC_I001">명함추가</a>]
		</div>
	</div>
	<!-- 명함 추가 결과 끝-->
